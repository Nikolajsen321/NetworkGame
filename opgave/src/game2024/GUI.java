...
//			me = new Player("Orville",9,4,"up");
	...
	public void setMyPlayer(){
		try {
			me = new Player("Orville", 9, 4, "up");
			outToServer.writeBytes("Orville");
		...
		if (board[y+delta_y].charAt(x+delta_x)=='w') {
			...
			if (p!=null) {
              ...
              p.addPoints(-10);
				...
				me.setXpos(x);
				me.setYpos(y);
				sendUpdateToServer("MOVE " + delta_x + " " + delta_y + " " + direction);
			}
		}
		scoreList.setText(getScoreList());
	}
	public void sendUpdateToServer(String updateMessage) {
		try {
			outToServer.writeBytes(updateMessage + "\n");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
